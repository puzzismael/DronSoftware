...
public class IdentificadorPaciente  extends DefaultListCellRenderer  {
	public IdentificadorPaciente() {
	}
	...
	renderer.setBorder(new TitledBorder(LineBorder.createGrayLineBorder(),"Paciente"));
